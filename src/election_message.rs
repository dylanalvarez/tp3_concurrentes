...
mod tests {
    ...
    #[test]
    fn from_bytes() {
        assert_eq!( Some(ElectionMessage::Election), ElectionMessage::from_bytes(&[b'E']));
        assert_eq!( Some(ElectionMessage::OkElection), ElectionMessage::from_bytes(&[b'O']));
        assert_eq!( Some(ElectionMessage::Coordinator), ElectionMessage::from_bytes(&[b'C']));
    }
}
